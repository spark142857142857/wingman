...
pub(super) struct PreparedSourceFileV1 {
    pub(super) display: String,
    pub(super) resolved: PathBuf,
    pub(super) basename: OsString,
    pub(super) handle: File,
    pub(super) identity: FileIdentityV1,
}

pub(super) enum PreparedSourceV1 {
...
pub(super) struct PreparedSourceDirectoryV1 {
    pub(super) display: String,
    pub(super) resolved: PathBuf,
    pub(super) basename: OsString,
    pub(super) tree: PreparedCopyDirectoryV1,
}

pub(super) struct PreparedCopyDirectoryV1 {
    pub(super) handle: File,
    pub(super) identity: FileIdentityV1,
...
pub(super) enum PreparedDestinationStateV1 {
    Missing,
...
pub(super) struct PreparedDestinationV1 {
    pub(super) display: String,
    pub(super) resolved: PathBuf,
    pub(super) parent: Option<File>,
    pub(super) leaf: Option<OsString>,
    pub(super) state: PreparedDestinationStateV1,
}

pub(super) enum CpPreflightFailureV1 {
    KnownSafety {
        display: String,
        message: &'static str,
    },
...
pub(super) enum SourceDirectoryRecheckResultV1 {
    Matches,
    Changed,
    Cancelled,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(super) enum TransferSourceAccessV1 {
    Copy,
    Move,
}

pub(crate) fn execute_copy<E: Write>(
...
pub(super) fn execute_file_copy<E: Write>(
...
pub(super) fn execute_directory_copy<E: Write>(
...
pub(super) fn recheck_source_directory(
    directory: &PreparedCopyDirectoryV1,
    cancellation: &RunnerCancellationV1,
...
pub(super) fn close_prepared_source_children(directory: PreparedCopyDirectoryV1) -> File {
    for entry in directory.entries {
        match entry {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(super) enum PreparedSourceDeleteResultV1 {
    Success,
    Cancelled,
    Failed,
}

pub(super) fn delete_prepared_source_directory(
    directory: PreparedCopyDirectoryV1,
    cancellation: &RunnerCancellationV1,
...
pub(super) fn destination_still_matches(
    parent: &File,
    leaf: &OsStr,
